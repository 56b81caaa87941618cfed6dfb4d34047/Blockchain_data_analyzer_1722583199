...
Vue.component("items_table_component_1722583501", {
    template: `
    <section id="items-table-component" class="py-8 bg-gradient-to-br from-pink-400 to-purple-600 relative overflow-hidden">
        ...
        <div class="relative z-10">
            ...
            <div id="costs-table-container" class="overflow-x-auto backdrop-blur-lg bg-white bg-opacity-20 rounded-xl shadow-lg">
                <table id="costs-table" class="table-auto w-full text-sm">
                    ...
                    <tbody id="costs-table-body">
                        <tr class="group hover:bg-white hover:bg-opacity-30 transition-all duration-300" id="costs-row-1">
                            <th scope="row" class="text-left font-normal px-4 py-3" id="costs-cell-description-1">
                                <div class="font-semibold mb-0.5 text-white" id="costs-link-1">
                                    <a class="hover:text-pink-200 transition-colors duration-300" href="details.html">
                            ...
                            <td class="font-semibold text-right px-4 py-3 text-white" id="costs-cell-cost-1">
                                <a class="hover:text-pink-200 transition-colors duration-300" href="details.html">$99/month</a>
                            </td>
                        </tr>
                        <tr class="group hover:bg-white hover:bg-opacity-30 transition-all duration-300" id="costs-row-2">
                            ...
                            <td class="font-semibold text-right px-4 py-3 text-white" id="costs-cell-cost-2">
                                <a class="hover:text-pink-200 transition-colors duration-300" href="details.html">$149/month</a>
                            </td>
                        </tr>
                        <tr class="group hover:bg-white hover:bg-opacity-30 transition-all duration-300" id="costs-row-3">
                            <th scope="row" class="text-left font-normal px-4 py-3" id="costs-cell-description-3">
                                <div class="font-semibold mb-0.5 text-white" id="costs-link-3">
                                    <a class="hover:text-pink-200 transition-colors duration-300" href="details.html">On-Chain Analytics Suite</a>
                                </div>
                            ...
                            <td class="font-semibold text-right px-4 py-3 text-white" id="costs-cell-cost-3">
                                <a class="hover:text-pink-200 transition-colors duration-300" href="details.html">$199/month</a>
                            </td>
                        </tr>
                        <tr class="group hover:bg-white hover:bg-opacity-30 transition-all duration-300" id="costs-row-4">
                            <th scope="row" class="text-left font-normal px-4 py-3" id="costs-cell-description-4">
                                <div class="font-semibold mb-0.5 text-white" id="costs-link-4">
                                    <a class="hover:text-pink-200 transition-colors duration-300" href="details.html">Decentralized App Monitor</a>
                                </div>
                            ...
                            <td class="font-semibold text-right px-4 py-3 text-white" id="costs-cell-cost-4">
                                <a class="hover:text-pink-200 transition-colors duration-300" href="details.html">$249/month</a>
                            </td>
                        </tr>
                        <tr class="group hover:bg-white hover:bg-opacity-30 transition-all duration-300" id="costs-row-5">
                            <th scope="row" class="text-left font-normal px-4 py-3" id="costs-cell-description-5">
                                <div class="font-semibold mb-0.5 text-white" id="costs-link-5">
                                    <a class="hover:text-pink-200 transition-colors duration-300" href="details.html">Crypto Wallet Tracker</a>
                                </div>
                        ...
                        <tr class="group hover:bg-white hover:bg-opacity-30 transition-all duration-300" id="costs-row-6">
                            <th scope="row" class="text-left font-normal px-4 py-3" id="costs-cell-description-6">
                                <div class="font-semibold mb-0.5 text-white" id="costs-link-6">
                                    <a class="hover:text-pink-200 transition-colors duration-300" href="details.html">ICO Investigation Tool</a>
                                </div>
                            ...
                            <td class="font-semibold text-right px-4 py-3 text-white" id="costs-cell-cost-6">
                                <a class="hover:text-pink-200 transition-colors duration-300" href="details.html">$299/month</a>
                            </td>
                        </tr>
                    </tbody>
                    <tfoot id="costs-table-footer">
                        <tr>
                            ...
                            <td id="total-cost" class="font-bold text-right text-lg px-4 py-3 text-pink-200">$1094</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
