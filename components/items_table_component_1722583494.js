...
Vue.component("items_table_component_1722583494", {
    template: `
    <section id="items-table-component" class="py-8 bg-gradient-to-br from-pink-400 to-purple-600 backdrop-blur-lg bg-opacity-30 rounded-3xl shadow-lg">
        <h2 id="costs-title" class="text-2xl font-bold mb-5 text-white text-center">Blockchain Analysis Tools</h2>
        <div id="costs-table-container" class="overflow-x-auto px-4">
            <table id="costs-table" class="table-auto w-full text-sm bg-white bg-opacity-20 backdrop-filter backdrop-blur-xl rounded-xl">
                ...
                <tbody id="costs-table-body">
                    <tr class="group transition duration-300 ease-in-out hover:bg-white hover:bg-opacity-30" id="costs-row-1">
                        <th scope="row" class="text-left font-normal px-4 py-4" id="costs-cell-description-1">
                        ...
                        <td class="font-semibold text-right px-4 py-4 text-white" id="costs-cell-cost-1">
                            <a class="hover:text-pink-200" href="details.html">$99/month</a>
                        </td>
                    </tr>
                    <tr class="group transition duration-300 ease-in-out hover:bg-white hover:bg-opacity-30" id="costs-row-2">
                        <th scope="row" class="text-left font-normal px-4 py-4" id="costs-cell-description-2">
                        ...
                        <td class="font-semibold text-right px-4 py-4 text-white" id="costs-cell-cost-2">
                            <a class="hover:text-pink-200" href="details.html">$149/month</a>
                        </td>
                    </tr>
                    <tr class="group transition duration-300 ease-in-out hover:bg-white hover:bg-opacity-30" id="costs-row-3">
                        <th scope="row" class="text-left font-normal px-4 py-4" id="costs-cell-description-3">
                        ...
                        <td class="font-semibold text-right px-4 py-4 text-white" id="costs-cell-cost-3">
                            <a class="hover:text-pink-200" href="details.html">$199/month</a>
                        </td>
                    </tr>
                    <tr class="group transition duration-300 ease-in-out hover:bg-white hover:bg-opacity-30" id="costs-row-4">
                        <th scope="row" class="text-left font-normal px-4 py-4" id="costs-cell-description-4">
                        ...
                        <td class="font-semibold text-right px-4 py-4 text-white" id="costs-cell-cost-4">
                            <a class="hover:text-pink-200" href="details.html">$249/month</a>
                        </td>
                    </tr>
                    <tr class="group transition duration-300 ease-in-out hover:bg-white hover:bg-opacity-30" id="costs-row-5">
                        <th scope="row" class="text-left font-normal px-4 py-4" id="costs-cell-description-5">
                        ...
                        <td class="font-semibold text-right px-4 py-4 text-white" id="costs-cell-cost-5">
                            <a class="hover:text-pink-200" href="details.html">$99/month</a>
                        </td>
                    </tr>
                    <tr class="group transition duration-300 ease-in-out hover:bg-white hover:bg-opacity-30" id="costs-row-6">
                        <th scope="row" class="text-left font-normal px-4 py-4" id="costs-cell-description-6">
                        ...
                        <td class="font-semibold text-right px-4 py-4 text-white" id="costs-cell-cost-6">
                ...
                <tfoot id="costs-table-footer">
                    <tr>
                        <th id="total-description" scope="row" class="text-left font-normal px-4 py-4">
                            <p id="total-description-text" class="italic text-purple-200">TOTAL in USD</p>
                        </th>
                        <td id="total-cost" class="font-bold text-right text-lg px-4 py-4 text-pink-300">$1094</td>
                    </tr>
                </tfoot>
            </table>
        </div>
